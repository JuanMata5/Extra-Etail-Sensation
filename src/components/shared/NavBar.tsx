...
export const NavBar = () => {
   ...
   return (
    <header className="bg-white py-4 flex items-center justify-between border-b border-slate-200 px-5 relative">
      ...
      <div
        className={`absolute top-[120px] left-0 right-0 w-[70%] h-[200vh]  bg-white shadow-lg p-5 text-xl gap-[50px] flex flex-col items-start space-y-4 transition-all duration-300 z-50 ${
          isOpen ? "block" : "hidden"
